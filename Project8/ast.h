...
protected:
  ...
  bool mDebug;
  //std::vector<CFunctionEntry *> mArgs;
...
protected:
  CFunctionEntry * mEntry;
  ASTNode * mBody;

  public:
    ASTNodeFunction(CFunctionEntry * entry, ASTNode * body);
...
protected:
  ...
  public:
    ASTNodeFunctionCall(CFunctionEntry * entry, std::string name);
...
class ASTNodeReturn : public ASTNode {
  protected:
    ...
    ASTNode * mArgument;
  public:
    ASTNodeReturn(ASTNode * argument, CFunctionEntry *current_function);
